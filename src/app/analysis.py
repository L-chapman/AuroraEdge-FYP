...
def generate_all_charts(rows: Optional[List[Dict]] = None) -> List[Path]:
    """Generate the complete operational reporting chart set."""
    if rows is None:
...
def generate_summary_report(
    ...
    lines.extend(
        [
            ...
            "## Methodology",
            "",
            "This analysis was conducted using NorthFlux Security, which performs:",
            "",
            ...
            "---",
            "",
            "*Report generated by NorthFlux Security*",
        ]
    )
...
def main():
    ...
    logger.info("NorthFlux Security Analysis Tool")
