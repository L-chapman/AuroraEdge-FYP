# AuroraEdge Documentation Index

This file is the central map for the AuroraEdge documentation set.

Use it when you want to know which document to read first, which files are actively maintained guidance, and which files are historical project evidence.
...
| `docs/SCAN_ANALYSIS.md` | Scan dataset findings and observations |
| `docs/PRIVACY_AND_ETHICS.md` | Legal, privacy, and ethical boundaries |
| `docs/DEVELOPMENT_TIMELINE.md` | Structured timeline view of the project |
...
|--------------|---------|
| `docs/Stage_*_README.md` | Stage-by-stage snapshots of feature progress |
| `docs/progress/` | Historical project progress records |

These files are useful as project history and evidence. They are not the best entry point for first-time users.

---

## Style Note

AuroraEdge documentation uses UK English in prose.

Exceptions are preserved where the original spelling is part of:

- source code or exact command output
- quoted strings or API responses
- vendor product names or official service titles
- URLs, standards names, or licence titles
