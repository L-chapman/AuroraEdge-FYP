...
fig.savefig("docs/academic/archive/figures/grade_distribution.png", dpi=300)
```
...
fig.savefig("docs/academic/archive/figures/protocol_adoption.png", dpi=300)
```
...
fig.savefig("docs/academic/archive/figures/score_histogram.png", dpi=300)
```
...
## Output Directory
Figures saved to: `docs/academic/archive/figures/`
